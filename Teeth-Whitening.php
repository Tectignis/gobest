                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-4">
                          ...
                          <br>
                            ...
                            <br><br>
                            <p style="font-size:16px; line-height: 200%;">Looking for <a href="index.php" style="text-decoration:none !important;"> <strong> teeth whitening dentist in Pimpri Chinchwad?</strong></a></p>
                            <a href="javascript:void()" onclick="openNav()" class="btn mt-3 toggle1 display">BOOK AN APPOINTMENT </a>
